...
export async function addAuction(auction: MetaData): Promise<MetaData | undefined> {
  ...
  const item = {
    ...
    InterimGoalAmount: {N: auction.interimGoalAmount ? auction.interimGoalAmount.toString() : null},
    FinalGoalAmount: {N: auction.finalGoalAmount ? auction.finalGoalAmount.toString() : null},
