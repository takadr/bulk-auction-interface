    ...
    args: [
      ...
      utils.hexlify(
        abi.encode(
          ...
          [
            utils.parseEther(String(debouncedToken.initialSupply)),
            debouncedToken.name,
            debouncedToken.symbol,
        ...
        <ModalBody pb={6}>
          <div>
            <form onSubmit={formikProps.handleSubmit}>
              ...
              >
                <FormLabel htmlFor="name" alignItems={"baseline"}>
                  Name
                  <Tooltip hasArrow label={"TODO explanation"}>
                ...
                <Input
                  ...
                  placeholder="e.g.) DFGC Governance Token"
                />
              ...
              <FormControl
                mt={4}
                isInvalid={
                  !!formikProps.errors.initialSupply &&
                  !!formikProps.touched.initialSupply
                }
              >
                <FormLabel alignItems={"baseline"}>
                  Initial Supply
                ...
                <NumberInput
                  name="initialSupply"
                  value={formikProps.values.initialSupply}
                  min={1}
                  max={
                    115792089237316195423570985008687907853269984665640564039456
                  }
                  onBlur={formikProps.handleBlur}
                  onChange={(_: string, val: number) =>
